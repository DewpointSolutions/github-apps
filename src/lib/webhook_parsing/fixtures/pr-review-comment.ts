...
const payload: PullRequestReviewCommentCreatedEvent = {
  action: "created",
  comment: {
    url: "https://api.github.com/repos/DewpointSolutions/github-apps/pulls/comments/692415992",
    pull_request_review_id: 734376930,
    id: 692415992,
    node_id: "MDI0OlB1bGxSZXF1ZXN0UmV2aWV3Q29tbWVudDY5MjQxNTk5Mg==",
    diff_hunk:
      "@@ -6787,9 +6787,9 @@ path-loader@^1.0.10:\n" +
      '     superagent "^3.8.3"\n' +
      " \n" +
      " path-parse@^1.0.6:\n" +
      '-  version "1.0.6"\n' +
    ...
    original_commit_id: "eab29c41d0e744dac0239e20e3915d701bff3f76",
    user: {
      login: "sibljon",
      id: 442307,
    ...
    created_at: "2021-08-19T19:20:21Z",
    updated_at: "2021-08-19T19:20:28Z",
    html_url:
      "https://github.com/DewpointSolutions/github-apps/pull/4#discussion_r692415992",
    pull_request_url:
  ...
  pull_request: {
    ...
    closed_at: null,
    merged_at: null,
    merge_commit_sha: "4191b8f0997a65e51772a43029164490a945c149",
    assignee: null,
    assignees: [],
    requested_reviewers: [],
    requested_teams: [],
  ...
  repository: {
    ...
    updated_at: "2021-08-19T19:18:51Z",
    pushed_at: "2021-08-19T19:18:48Z",
