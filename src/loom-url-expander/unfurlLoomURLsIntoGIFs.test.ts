...
describe("unfurlLoomURLsIntoGIFs", () => {
  it("works with a single Loom link", async () => {
    const response = await unfurlLoomURLsIntoGIFs(
    ...
    expect(response).toEqual({
      ...
      stringWithUnfurledLoomURLs:
        "[![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/3739163d58bb419ba51ac893412b5774-00001.gif)](https://www.loom.com/share/3739163d58bb419ba51ac893412b5774)",
    });
  });

  it("works when the URL is appended to other text", async () => {
    const response = await unfurlLoomURLsIntoGIFs(
      "Check out this change: https://www.loom.com/share/5ece8644ee18464eacebaf0fb68bcd64"
    );
    expect(response).toEqual({
      numLoomURLsUnfurled: 1,
      didMakeLoomPreviewChange: true,
      stringWithUnfurledLoomURLs: `Check out this change:
[![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/5ece8644ee18464eacebaf0fb68bcd64-5f2c832a86886950.gif)](https://www.loom.com/share/5ece8644ee18464eacebaf0fb68bcd64)`,
    });
  });
...
https://www.loom.com/share/c973ee1b21044179877a08e299d56c12`
    ...
    expect(response).toEqual({
      ...
      didMakeLoomPreviewChange: true,
      stringWithUnfurledLoomURLs: `[![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/3739163d58bb419ba51ac893412b5774-00001.gif)](https://www.loom.com/share/3739163d58bb419ba51ac893412b5774)
[![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/c973ee1b21044179877a08e299d56c12-00001.gif)](https://www.loom.com/share/c973ee1b21044179877a08e299d56c12)`,
    });
  });
...
[![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/3739163d58bb419ba51ac893412b5774-00001.gif)](https://www.loom.com/share/3739163d58bb419ba51ac893412b5774)`,
  ...
  it("doesn't touch inline already-unfurled links", async () => {
    const response = await unfurlLoomURLsIntoGIFs(
      `The change in this PR is very important to me. I put a lot of effort into it. See the following video for a demo of this change: [![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/3739163d58bb419ba51ac893412b5774-00001.gif)](https://www.loom.com/share/3739163d58bb419ba51ac893412b5774)`
    );
    expect(response).toEqual({
      numLoomURLsUnfurled: 0,
      didMakeLoomPreviewChange: false,
      stringWithUnfurledLoomURLs: `The change in this PR is very important to me. I put a lot of effort into it. See the following video for a demo of this change: [![LOOM DEMO](https://cdn.loom.com/sessions/thumbnails/3739163d58bb419ba51ac893412b5774-00001.gif)](https://www.loom.com/share/3739163d58bb419ba51ac893412b5774)`,
    });
  });
